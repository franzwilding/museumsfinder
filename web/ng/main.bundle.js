...
var Data = (function () {
    ...
    Data.prototype.goTo = function (index) {
    ...
    Data.prototype.find = function () {
        return this.http.post(this.searchUrl, this.getSearchData()).map(function (res) { return res.json(); });
    };
    return Data;
}());
Data = __decorate([
...
var Results = (function () {
    function Results(data) {
        ...
        this.result = [];
        this.data.onCurrentQuestionChange.subscribe(function (result) {
    ...
    Results.prototype.find = function () {
        var _this = this;
        this.result = [];
        this.loading = true;
        this.data.find().subscribe(function (result) {
            _this.result = result;
            _this.loading = false;
        }, function () {
